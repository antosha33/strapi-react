...
function UsersPanel() {
    ...
    return (
        <div 
            ...
            <div className={`${isOtherShowed ? 'opacity-100 translate-y-0 duration-300 ease-in-out visible' : 'opacity-0 translate-y-[10%] invisible'}  absolute  top-[100%] left-0 right-0 border border-Content/Border border-t-0`}>
