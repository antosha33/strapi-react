            ...
            contentElement={() => {
                return (
                    <div
                        ...
                        className='ReactModal__Content p-[70px] bg-white w-[100%] max-w-[76rem] relative'>
                        <span
                            onClick={closeModal}
                        ...
                        <span className='block text-center text-Regular(48_52) text-Content/Dark mb-[5rem]'>{title}</span>
                        {children}
                    </div>
                )
            }}
